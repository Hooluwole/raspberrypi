...
default_args = {
  ...
  'mqtt_broker' : 'cf4c95c3b5aa4e19accdf7e704274d73.s1.eu.hivemq.cloud', # <<<****** Enter MQTT broker i.e. test.mosquitto.org
...
@dag(dag_id="tml_mqtt_step_3_kafka_producetotopic_dag_lastattempt2-a89c", default_args=default_args, tags=["tml_mqtt_step_3_kafka_producetotopic_dag_lastattempt2-a89c"], schedule=None,catchup=False)
