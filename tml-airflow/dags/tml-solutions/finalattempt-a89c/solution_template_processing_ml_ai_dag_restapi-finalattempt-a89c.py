...
step1 = importlib.import_module("tml-solutions.finalattempt-a89c.tml_system_step_1_getparams_dag-finalattempt-a89c")
step2 = importlib.import_module("tml-solutions.finalattempt-a89c.tml_system_step_2_kafka_createtopic_dag-finalattempt-a89c")
step3 = importlib.import_module("tml-solutions.finalattempt-a89c.tml_read_RESTAPI_step_3_kafka_producetotopic_dag-finalattempt-a89c")
step4 = importlib.import_module("tml-solutions.finalattempt-a89c.tml_system_step_4_kafka_preprocess_dag-finalattempt-a89c")
step5 = importlib.import_module("tml-solutions.finalattempt-a89c.tml_system_step_5_kafka_machine_learning_dag-finalattempt-a89c")
step6 = importlib.import_module("tml-solutions.finalattempt-a89c.tml_system_step_6_kafka_predictions_dag-finalattempt-a89c")
step7 = importlib.import_module("tml-solutions.finalattempt-a89c.tml_system_step_7_kafka_visualization_dag-finalattempt-a89c")
step8 = importlib.import_module("tml-solutions.finalattempt-a89c.tml_system_step_8_deploy_solution_to_docker_dag-finalattempt-a89c")
step9 = importlib.import_module("tml-solutions.finalattempt-a89c.tml_system_step_9_privategpt_qdrant_dag-finalattempt-a89c")
step10 = importlib.import_module("tml-solutions.finalattempt-a89c.tml_system_step_10_documentation_dag-finalattempt-a89c")


with DAG(
    dag_id="solution_preprocessing_ml_ai_restapi_dag-finalattempt-a89c",
